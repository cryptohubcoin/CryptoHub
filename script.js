...
// === JS Block 1 ===
    ...
    // Nav dropdown i18n
    const _ni = { ar: { navSections: 'أقسام الموقع', navCryptoDesc: '+10,000 عملة • أسعار لحظية • تحليل AI', navExchDesc: '500 منصة عالمية • روابط تسجيل مباشرة', navMetalsDesc: 'الذهب • الفضة • البلاتين • البلاديوم', navStocksDesc: 'أسهم مرمّزة • صناديق ETF • بيانات Yahoo Finance', tabCommodities: 'NFT Collections', tabStocks: 'الأسهم وETF', aiPredictorTitle: 'منبئ الأسعار بالذكاء الاصطناعي', aiPredictorDesc: 'توقع الأسعار 48 ساعة • 5 طبقات AI', aiPredictorBadge: 'جديد', tokenVestingTitle: 'جدول فتح الرموز', tokenVestingDesc: 'مواعيد فك القفل • جداول الاستحقاق', tokenVestingBadge: 'جديد', navAiTools: 'أدوات الذكاء الاصطناعي', navAiToolsSub: 'تحليل ذكي وتنبؤات', navWhaleAlert: 'تنبيهات الحيتان', navWhaleAlertSub: 'معاملات ضخمة مباشرة', navPortfolio: 'متتبع المحفظة', navPortfolioSub: 'تتبع أصولك', comingSoon: 'قريباً', navBlogSub: 'مقالات وأدلة' }, en: { navSections: 'Site Sections', navCryptoDesc: '10,000+ Coins • Real-time Prices • AI Analysis', navExchDesc: '500 Global Exchanges • Direct Registration', navMetalsDesc: 'Gold • Silver • Platinum • Palladium', navStocksDesc: 'Tokenized Stocks • ETFs • Yahoo Finance Data', tabCommodities: 'NFT Collections', tabStocks: 'Stocks & ETFs', aiPredictorTitle: 'AI Price Predictor', aiPredictorDesc: '48h price forecast • 5-layer AI', aiPredictorBadge: 'NEW', tokenVestingTitle: 'Token Vesting & Unlocks', tokenVestingDesc: 'Vesting schedules • Unlock dates', tokenVestingBadge: 'NEW', navAiTools: 'AI Tools', navAiToolsSub: 'Smart analysis and predictions', navWhaleAlert: 'Whale Alert', navWhaleAlertSub: 'Large transactions live', navPortfolio: 'Portfolio Tracker', navPortfolioSub: 'Track your holdings', comingSoon: 'Coming Soon', navBlogSub: 'Articles and guides' }, zh: { navSections: '网站板块', navCryptoDesc: '5000+ 币种 • 实时价格 • AI分析', navExchDesc: '500家全球交易所 • 直接注册链接', navMetalsDesc: '黄金 • 白银 • 铂金 • 钯金', navStocksDesc: '代币化股票 • ETF • Yahoo Finance数据', tabCommodities: '贵金属', tabStocks: '股票和ETF', aiPredictorTitle: 'AI价格预测器', aiPredictorDesc: '48小时价格预测 • 5层AI分析', aiPredictorBadge: '新', tokenVestingTitle: '代币解锁日历', tokenVestingDesc: '归属计划 • 解锁日期', tokenVestingBadge: '新', navAiTools: 'AI工具', navAiToolsSub: '智能分析和预测', navWhaleAlert: '鲸鱼警报', navWhaleAlertSub: '实时大额交易', navPortfolio: '投资组合跟踪', navPortfolioSub: '跟踪您的持仓', comingSoon: '即将推出', navBlogSub: '文章和指南' }, es: { navSections: 'Secciones', navCryptoDesc: '5000+ Monedas • Precios en Vivo • Análisis IA', navExchDesc: '500 Exchanges Globales • Registro Directo', navMetalsDesc: 'Oro • Plata • Platino • Paladio', navStocksDesc: 'Acciones Tokenizadas • ETFs • Yahoo Finance', tabCommodities: 'Metales Preciosos', tabStocks: 'Acciones y ETFs', aiPredictorTitle: 'Predictor de Precios IA', aiPredictorDesc: 'Pronóstico 48h • IA 5 capas', aiPredictorBadge: 'NUEVO', tokenVestingTitle: 'Vesting de Tokens', tokenVestingDesc: 'Calendarios de bloqueo • Fechas de desbloqueo', tokenVestingBadge: 'NUEVO', navAiTools: 'Herramientas IA', navAiToolsSub: 'Análisis inteligente', navWhaleAlert: 'Alerta Ballena', navWhaleAlertSub: 'Grandes transacciones en vivo', navPortfolio: 'Rastreador Cartera', navPortfolioSub: 'Rastrea tus activos', comingSoon: 'Próximamente', navBlogSub: 'Artículos y guías' }, pt: { navSections: 'Seções', navCryptoDesc: '5000+ Moedas • Preços em Tempo Real • IA', navExchDesc: '500 Exchanges Globais • Registro Direto', navMetalsDesc: 'Ouro • Prata • Platina • Paládio', navStocksDesc: 'Ações Tokenizadas • ETFs • Yahoo Finance', tabCommodities: 'Metais Preciosos', tabStocks: 'Ações e ETFs', aiPredictorTitle: 'Preditor de Preços IA', aiPredictorDesc: 'Previsão 48h • IA 5 camadas', aiPredictorBadge: 'NOVO', tokenVestingTitle: 'Vesting de Tokens', tokenVestingDesc: 'Cronogramas • Datas de desbloqueio', tokenVestingBadge: 'NOVO', navAiTools: 'Ferramentas IA', navAiToolsSub: 'Análise inteligente', navWhaleAlert: 'Alerta Baleia', navWhaleAlertSub: 'Grandes transações ao vivo', navPortfolio: 'Rastreador Carteira', navPortfolioSub: 'Rastreie seus ativos', comingSoon: 'Em breve', navBlogSub: 'Artigos e guias' }, fr: { navSections: 'Sections', navCryptoDesc: '10,000+ Cryptos • Prix en Direct • Analyse IA', navExchDesc: '500 Plateformes Mondiales • Inscription Directe', navMetalsDesc: 'Or • Argent • Platine • Palladium', navStocksDesc: 'Actions Tokenisées • ETFs • Yahoo Finance', tabCommodities: 'Métaux Précieux', tabStocks: 'Actions et ETFs', aiPredictorTitle: 'Prédicteur de Prix IA', aiPredictorDesc: 'Prévision 48h • IA 5 couches', aiPredictorBadge: 'NOUVEAU', tokenVestingTitle: 'Vesting de Tokens', tokenVestingDesc: 'Calendriers de vesting • Déblocages', tokenVestingBadge: 'NOUVEAU', navAiTools: 'Outils IA', navAiToolsSub: 'Analyse intelligente', navWhaleAlert: 'Alerte Baleine', navWhaleAlertSub: 'Grandes transactions en direct', navPortfolio: 'Suivi Portefeuille', navPortfolioSub: 'Suivez vos avoirs', comingSoon: 'Bientôt', navBlogSub: 'Articles et guides' }, de: { navSections: 'Bereiche', navCryptoDesc: '10,000+ Coins • Echtzeitpreise • KI-Analyse', navExchDesc: '500 Globale Börsen • Direkte Registrierung', navMetalsDesc: 'Gold • Silber • Platin • Palladium', navStocksDesc: 'Tokenisierte Aktien • ETFs • Yahoo Finance', tabCommodities: 'Edelmetalle', tabStocks: 'Aktien & ETFs', aiPredictorTitle: 'KI-Preisvorhersage', aiPredictorDesc: '48h Preisprognose • 5-Schicht-KI', aiPredictorBadge: 'NEU', tokenVestingTitle: 'Token-Vesting', tokenVestingDesc: 'Vesting-Pläne • Freigabedaten', tokenVestingBadge: 'NEU', navAiTools: 'KI-Tools', navAiToolsSub: 'Intelligente Analyse', navWhaleAlert: 'Wal-Alarm', navWhaleAlertSub: 'Große Transaktionen live', navPortfolio: 'Portfolio-Tracker', navPortfolioSub: 'Bestände verfolgen', comingSoon: 'Demnächst', navBlogSub: 'Artikel und Leitfäden' }, it: { navSections: 'Sezioni', navCryptoDesc: '10,000+ Crypto • Prezzi in Tempo Reale • IA', navExchDesc: '500 Exchange Globali • Registrazione Diretta', navMetalsDesc: 'Oro • Argento • Platino • Palladio', navStocksDesc: 'Azioni Tokenizzate • ETF • Yahoo Finance', tabCommodities: 'Metalli Preziosi', tabStocks: 'Azioni ed ETF', aiPredictorTitle: 'Predittore Prezzi IA', aiPredictorDesc: 'Previsione 48h • IA 5 livelli', aiPredictorBadge: 'NUOVO', tokenVestingTitle: 'Vesting Token', tokenVestingDesc: 'Pianificazione • Date di sblocco', tokenVestingBadge: 'NUOVO', navAiTools: 'Strumenti IA', navAiToolsSub: 'Analisi intelligente', navWhaleAlert: 'Alerta Balena', navWhaleAlertSub: 'Grandi transazioni live', navPortfolio: 'Tracker Portfolio', navPortfolioSub: 'Monitora i tuoi asset', comingSoon: 'Prossimamente', navBlogSub: 'Articoli e guide' }, ru: { navSections: 'Разделы', navCryptoDesc: '5000+ Монет • Цены в Реальном Времени • ИИ', navExchDesc: '500 Биржи • Прямая Регистрация', navMetalsDesc: 'Золото • Серебро • Платина • Палладий', navStocksDesc: 'Токенизированные Акции • ETF • Yahoo Finance', tabCommodities: 'Драгоценные Металлы', tabStocks: 'Акции и ETF', aiPredictorTitle: 'ИИ Прогнозатор Цен', aiPredictorDesc: 'Прогноз на 48ч • ИИ 5 уровней', aiPredictorBadge: 'НОВЫЙ', tokenVestingTitle: 'Вестинг Токенов', tokenVestingDesc: 'Расписание вестинга • Даты разблокировки', tokenVestingBadge: 'НОВЫЙ', navAiTools: 'ИИ-инструменты', navAiToolsSub: 'Умный анализ', navWhaleAlert: 'Сигнал кита', navWhaleAlertSub: 'Крупные транзакции', navPortfolio: 'Отслеживание портфеля', navPortfolioSub: 'Следите за активами', comingSoon: 'Скоро', navBlogSub: 'Статьи и руководства' }, tr: { navSections: 'Bölümler', navCryptoDesc: '10,000+ Coin • Anlık Fiyatlar • AI Analizi', navExchDesc: '500 Küresel Borsa • Doğrudan Kayıt', navMetalsDesc: 'Altın • Gümüş • Platin • Paladyum', navStocksDesc: 'Tokenize Hisseler • ETF • Yahoo Finance', tabCommodities: 'Değerli Metaller', tabStocks: 'Hisseler ve ETF', aiPredictorTitle: 'AI Fiyat Tahmincisi', aiPredictorDesc: '48 saatlik tahmin • 5 katman AI', aiPredictorBadge: 'YENİ', tokenVestingTitle: 'Token Vesting', tokenVestingDesc: 'Vesting takvimleri • Kilit açma tarihleri', tokenVestingBadge: 'YENİ', navAiTools: 'AI Araçları', navAiToolsSub: 'Akıllı analiz', navWhaleAlert: 'Balina Alarmı', navWhaleAlertSub: 'Büyük işlemler canlı', navPortfolio: 'Portföy Takibi', navPortfolioSub: 'Varlıklarınızı takip edin', comingSoon: 'Yakında', navBlogSub: 'Makaleler ve rehberler' }, ja: { navSections: 'セクション', navCryptoDesc: '5000+ コイン • リアルタイム価格 • AI分析', navExchDesc: '500 取引所 • 直接登録リンク', navMetalsDesc: '金 • 銀 • プラチナ • パラジウム', navStocksDesc: 'トークン化株式 • ETF • Yahoo Finance', tabCommodities: '貴金属', tabStocks: '株式＆ETF', aiPredictorTitle: 'AI価格予測ツール', aiPredictorDesc: '48時間予測 • 5層AI分析', aiPredictorBadge: '新機能', tokenVestingTitle: 'トークンベスティング', tokenVestingDesc: 'ベスティングスケジュール • ロック解除日', tokenVestingBadge: '新機能', navAiTools: 'AIツール', navAiToolsSub: 'スマート分析', navWhaleAlert: 'クジラアラート', navWhaleAlertSub: '大口取引ライブ', navPortfolio: 'ポートフォリオ', navPortfolioSub: '保有資産を追跡', comingSoon: '近日公開', navBlogSub: '記事とガイド' }, ko: { navSections: '섹션', navCryptoDesc: '5000+ 코인 • 실시간 가격 • AI 분석', navExchDesc: '500 거래소 • 직접 가입', navMetalsDesc: '금 • 은 • 백금 • 팔라듐', navStocksDesc: '토큰화 주식 • ETF • Yahoo Finance', tabCommodities: '귀금속', tabStocks: '주식 & ETF', aiPredictorTitle: 'AI 가격 예측기', aiPredictorDesc: '48시간 예측 • 5계층 AI', aiPredictorBadge: '신규', tokenVestingTitle: '토큰 베스팅', tokenVestingDesc: '베스팅 일정 • 잠금 해제 날짜', tokenVestingBadge: '신규', navAiTools: 'AI 도구', navAiToolsSub: '스마트 분석', navWhaleAlert: '고래 알림', navWhaleAlertSub: '대규모 거래 실시간', navPortfolio: '포트폴리오 추적', navPortfolioSub: '보유 자산 추적', comingSoon: '곧 출시', navBlogSub: '기사 및 가이드' }, hi: { navSections: 'अनुभाग', navCryptoDesc: '5000+ कॉइन • रीयल-टाइम • AI विश्लेषण', navExchDesc: '500 एक्सचेंज • सीधा पंजीकरण', navMetalsDesc: 'सोना • चाँदी • प्लैटिनम • पैलेडियम', navStocksDesc: 'टोकनाइज़्ड स्टॉक • ETF • Yahoo Finance', tabCommodities: 'कीमती धातु', tabStocks: 'स्टॉक और ETF', aiPredictorTitle: 'AI मूल्य पूर्वानुमान', aiPredictorDesc: '48 घंटे का पूर्वानुमान • 5-परत AI', aiPredictorBadge: 'नया', tokenVestingTitle: 'टोकन वेस्टिंग', tokenVestingDesc: 'वेस्टिंग शेड्यूल • अनलॉक तारीखें', tokenVestingBadge: 'नया', navAiTools: 'AI टूल्स', navAiToolsSub: 'स्मार्ट विश्लेषण', navWhaleAlert: 'व्हेल अलर्ट', navWhaleAlertSub: 'बड़े लेनदेन लाइव', navPortfolio: 'पोर्टफोलियो ट्रैकर', navPortfolioSub: 'अपनी होल्डिंग्स ट्रैक करें', comingSoon: 'जल्द आ रहा है', navBlogSub: 'लेख और गाइड' }, nl: { navSections: 'Secties', navCryptoDesc: '10,000+ Coins • Realtime Prijzen • AI-Analyse', navExchDesc: '500 Wereldwijde Beurzen • Directe Registratie', navMetalsDesc: 'Goud • Zilver • Platina • Palladium', navStocksDesc: 'Getokeniseerde Aandelen • ETFs • Yahoo Finance', tabCommodities: 'Edelmetalen', tabStocks: 'Aandelen & ETFs', aiPredictorTitle: 'AI Prijsvoorspeller', aiPredictorDesc: '48u voorspelling • 5-laags AI', aiPredictorBadge: 'NIEUW', tokenVestingTitle: 'Token Vesting', tokenVestingDesc: 'Vesting schema\'s • Ontgrendeldata', tokenVestingBadge: 'NIEUW', navAiTools: 'AI-Tools', navAiToolsSub: 'Slimme analyse', navWhaleAlert: 'Walvis Alert', navWhaleAlertSub: 'Grote transacties live', navPortfolio: 'Portfolio Tracker', navPortfolioSub: 'Volg uw bezittingen', comingSoon: 'Binnenkort', navBlogSub: 'Artikelen en gidsen' }, pl: { navSections: 'Sekcje', navCryptoDesc: '5000+ Kryptowalut • Ceny na Żywo • AI', navExchDesc: '500 Giełdy • Bezpośrednia Rejestracja', navMetalsDesc: 'Złoto • Srebro • Platyna • Pallad', navStocksDesc: 'Tokenizowane Akcje • ETF • Yahoo Finance', tabCommodities: 'Metale Szlachetne', tabStocks: 'Akcje i ETF', aiPredictorTitle: 'Predyktor Cen AI', aiPredictorDesc: 'Prognoza 48h • AI 5 warstw', aiPredictorBadge: 'NOWY', tokenVestingTitle: 'Vesting Tokenów', tokenVestingDesc: 'Harmonogramy vestingu • Daty odblokowania', tokenVestingBadge: 'NOWY', navAiTools: 'Narzędzia AI', navAiToolsSub: 'Inteligentna analiza', navWhaleAlert: 'Alert Wieloryba', navWhaleAlertSub: 'Duże transakcje na żywo', navPortfolio: 'Tracker Portfela', navPortfolioSub: 'Śledź swoje aktywa', comingSoon: 'Wkrótce', navBlogSub: 'Artykuły i przewodniki' }, th: { navSections: 'หมวดหมู่', navCryptoDesc: '5000+ เหรียญ • ราคาเรียลไทม์ • AI', navExchDesc: '500 แพลตฟอร์ม • สมัครตรง', navMetalsDesc: 'ทอง • เงิน • แพลทินัม • แพลเลเดียม', navStocksDesc: 'หุ้นโทเค็น • ETF • Yahoo Finance', tabCommodities: 'โลหะมีค่า', tabStocks: 'หุ้นและ ETF', aiPredictorTitle: 'ตัวทำนายราคา AI', aiPredictorDesc: 'พยากรณ์ 48 ชม. • AI 5 ชั้น', aiPredictorBadge: 'ใหม่', tokenVestingTitle: 'Token Vesting', tokenVestingDesc: 'ตารางเวสติ้ง • วันปลดล็อค', tokenVestingBadge: 'ใหม่', navAiTools: 'เครื่องมือ AI', navAiToolsSub: 'การวิเคราะห์อัจฉริยะ', navWhaleAlert: 'แจ้งเตือนวาฬ', navWhaleAlertSub: 'ธุรกรรมขนาดใหญ่แบบเรียลไทม์', navPortfolio: 'ติดตามพอร์ต', navPortfolioSub: 'ติดตามสินทรัพย์ของคุณ', comingSoon: 'เร็วๆ นี้', navBlogSub: 'บทความและคู่มือ' }, vi: { navSections: 'Danh Mục', navCryptoDesc: '10,000+ Coin • Giá Thời Gian Thực • AI', navExchDesc: '500 Sàn Toàn Cầu • Đăng Ký Trực Tiếp', navMetalsDesc: 'Vàng • Bạc • Bạch Kim • Palladium', navStocksDesc: 'Cổ Phiếu Token • ETF • Yahoo Finance', tabCommodities: 'Kim Loại Quý', tabStocks: 'Cổ Phiếu & ETF', aiPredictorTitle: 'Dự Báo Giá AI', aiPredictorDesc: 'Dự báo 48h • AI 5 lớp', aiPredictorBadge: 'MỚI', tokenVestingTitle: 'Vesting Token', tokenVestingDesc: 'Lịch vesting • Ngày mở khóa', tokenVestingBadge: 'MỚI', navAiTools: 'Công cụ AI', navAiToolsSub: 'Phân tích thông minh', navWhaleAlert: 'Cảnh báo Cá Voi', navWhaleAlertSub: 'Giao dịch lớn trực tiếp', navPortfolio: 'Theo dõi Danh mục', navPortfolioSub: 'Theo dõi tài sản của bạn', comingSoon: 'Sắp ra mắt', navBlogSub: 'Bài viết và hướng dẫn' }, id: { navSections: 'Bagian', navCryptoDesc: '5000+ Koin • Harga Real-time • AI', navExchDesc: '500 Bursa Global • Registrasi Langsung', navMetalsDesc: 'Emas • Perak • Platinum • Paladium', navStocksDesc: 'Saham Token • ETF • Yahoo Finance', tabCommodities: 'Logam Mulia', tabStocks: 'Saham & ETF', aiPredictorTitle: 'Prediktor Harga AI', aiPredictorDesc: 'Prediksi 48j • AI 5 lapisan', aiPredictorBadge: 'BARU', tokenVestingTitle: 'Token Vesting', tokenVestingDesc: 'Jadwal vesting • Tanggal buka kunci', tokenVestingBadge: 'BARU', navAiTools: 'Alat AI', navAiToolsSub: 'Analisis cerdas', navWhaleAlert: 'Peringatan Whale', navWhaleAlertSub: 'Transaksi besar langsung', navPortfolio: 'Pelacak Portofolio', navPortfolioSub: 'Lacak aset Anda', comingSoon: 'Segera hadir', navBlogSub: 'Artikel dan panduan' }, uk: { navSections: 'Розділи', navCryptoDesc: '5000+ Монет • Ціни в Реальному Часі • ШІ', navExchDesc: '500 Біржі • Пряма Реєстрація', navMetalsDesc: 'Золото • Срібло • Платина • Паладій', navStocksDesc: 'Токенізовані Акції • ETF • Yahoo Finance', tabCommodities: 'Дорогоцінні Метали', tabStocks: 'Акції та ETF', aiPredictorTitle: 'ШІ Прогнозатор Цін', aiPredictorDesc: 'Прогноз на 48год • ШІ 5 рівнів', aiPredictorBadge: 'НОВИЙ', tokenVestingTitle: 'Вестинг Токенів', tokenVestingDesc: 'Розклад вестингу • Дати розблокування', tokenVestingBadge: 'НОВИЙ', navAiTools: 'ШІ-інструменти', navAiToolsSub: 'Розумний аналіз', navWhaleAlert: 'Сигнал кита', navWhaleAlertSub: 'Великі транзакції', navPortfolio: 'Відстеження портфеля', navPortfolioSub: 'Стежте за активами', comingSoon: 'Незабаром', navBlogSub: 'Статті та посібники' }, fa: { navSections: 'بخش‌ها', navCryptoDesc: '+5000 ارز • قیمت لحظه‌ای • تحلیل AI', navExchDesc: '500 صرافی • ثبت‌نام مستقیم', navMetalsDesc: 'طلا • نقره • پلاتین • پالادیوم', navStocksDesc: 'سهام توکنیزه • ETF • Yahoo Finance', tabCommodities: 'فلزات گرانبها', tabStocks: 'سهام و ETF', aiPredictorTitle: 'پیش‌بین قیمت AI', aiPredictorDesc: 'پیش‌بینی ۴۸ساعته • هوش مصنوعی ۵ لایه', aiPredictorBadge: 'جدید', tokenVestingTitle: 'وستینگ توکن', tokenVestingDesc: 'برنامه وستینگ • تاریخ‌های آزادسازی', tokenVestingBadge: 'جدید', navAiTools: 'ابزارهای AI', navAiToolsSub: 'تحلیل هوشمند', navWhaleAlert: 'هشدار نهنگ', navWhaleAlertSub: 'تراکنش‌های بزرگ زنده', navPortfolio: 'ردیاب پرتفولیو', navPortfolioSub: 'دارایی‌های خود را دنبال کنید', comingSoon: 'به زودی', navBlogSub: 'مقالات و راهنما' }, he: { navSections: 'מדורים', navCryptoDesc: '+5000 מטבעות • מחירים בזמן אמת • AI', navExchDesc: '500 בורסות • הרשמה ישירה', navMetalsDesc: 'זהב • כסף • פלטינה • פלדיום', navStocksDesc: 'מניות מטוקנות • ETF • Yahoo Finance', tabCommodities: 'מתכות יקרות', tabStocks: 'מניות ו-ETF', aiPredictorTitle: 'מנבא מחירים AI', aiPredictorDesc: 'תחזית 48 שעות • AI 5 שכבות', aiPredictorBadge: 'חדש', tokenVestingTitle: 'וסטינג טוקנים', tokenVestingDesc: 'לוח זמנים • תאריכי שחרור', tokenVestingBadge: 'חדש', navAiTools: 'כלי AI', navAiToolsSub: 'ניתוח חכם', navWhaleAlert: 'התראת לוויתן', navWhaleAlertSub: 'עסקאות גדולות בזמן אמת', navPortfolio: 'מעקב תיק', navPortfolioSub: 'עקוב אחר הנכסים שלך', comingSoon: 'בקרוב', navBlogSub: 'מאמרים ומדריכים' }, fi: { navSections: 'Osiot', navCryptoDesc: '5000+ Kolikkoa • Reaaliaikahinnat • AI', navExchDesc: '500 Pörssiä • Suorarekisteröinti', navMetalsDesc: 'Kulta • Hopea • Platina • Palladium', navStocksDesc: 'Tokenisoidut Osakkeet • ETF • Yahoo Finance', tabCommodities: 'Jalometallit', tabStocks: 'Osakkeet & ETF', aiPredictorTitle: 'AI Hintaennustaja', aiPredictorDesc: '48h ennuste • 5-kerros AI', aiPredictorBadge: 'UUSI', tokenVestingTitle: 'Token Vesting', tokenVestingDesc: 'Vesting-aikataulut • Vapautuspäivät', tokenVestingBadge: 'UUSI', navAiTools: 'AI-työkalut', navAiToolsSub: 'Älykäs analyysi', navWhaleAlert: 'Valas-hälytys', navWhaleAlertSub: 'Suuret transaktiot livenä', navPortfolio: 'Portfolion seuranta', navPortfolioSub: 'Seuraa omistuksiasi', comingSoon: 'Tulossa pian', navBlogSub: 'Artikkelit ja oppaat' } };
    ...
    function navTo(section) { closeDD(); document.body.style.overflow=''; requestAnimationFrame(function(){ swTab(section); var el = $('tab_' + section); if (el) el.scrollIntoView({ behavior: 'auto', block: 'start' }); if (section === 'crypto' && $('navCryptoBadge')) $('navCryptoBadge').textContent = allC.length ? allC.length.toLocaleString() : '--'; }); }
    ...
    const CMC_IDS = {
      ...
      PI: 31730, TAO: 22974, ONDO: 18626, FDUSD: 26081, AERO: 29270, ROBO: 30273, XUSD: 26688, A2Z: 32287, MMT: 38231, AIA: 38430,
...
<td class="text-end pr-4 col-vol" style="color:var(--t2);font-size:12px;font-weight:500;white-space:nowrap">${fN(parseFloat(c.vol) || 0)}</td>
    ...
    async function _fetchAllStocks() {
      ...
      // ── Step 1b: Fetch live prices via Stocks Proxy (new dedicated worker) ──
      const _fetchWorkerPrices = async () => {
        const WORKER = 'https://stocks-proxy.bitcoinswapnet.workers.dev';
        let total = 0;
        try {
          // New proxy returns ALL stocks in ONE request via /api/stocks
          const r = await fetch(`${WORKER}/api/stocks?limit=200&page=1`);
          if (!r.ok) { console.warn('[STK] Proxy failed:', r.status); return 0; }
          ...
          if (pages > 1) {
            ...
            for (let p = 2; p <= pages; p++) {
              promises.push(fetch(`${WORKER}/api/stocks?limit=200&page=${p}`).then(r => r.ok ? r.json() : null).catch(() => null));
            }
            const results = await Promise.all(promises);
            results.forEach(j => { if (j?.data) allData = allData.concat(j.data); });
          }

          // Apply to _stkP
          allData.forEach(s => {
            if (!s?.sy || !s.pr || s.pr <= 0) return;
            _stkP[s.sy] = {
              pr: s.pr, chg: s.chg || 0,
              hi: s.hi || s.pr, lo: s.lo || s.pr,
              vol: s.vol || 0, prevClose: s.prevCl || s.pr,
              closes: [s.prevCl || s.pr, s.pr],
              w52h: s.w52h || s.pr * 1.4, w52l: s.w52l || s.pr * 0.6,
              currency: s.cur || 'USD',
              mktTime: new Date(),
              src: s.src || 'Proxy',
              name: s.nm
        ...
        } catch (e) { console.warn('[STK] Proxy error:', e.message); }

        console.log('[STK] Stocks Proxy returned', total, 'symbols');
      ...
      // ── Step 5: Auto-refresh every 15s for real-time prices ──
      if (!window._mexcInterval) {
        window._mexcInterval = setInterval(async () => {
          if (!_stkTabD) return;
          // Refresh from Stocks Proxy + MEXC for live tokenized stocks
          await _fetchWorkerPrices();
          await _fetchMEXCNow();
