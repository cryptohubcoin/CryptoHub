...
// === JS Block 1 ===
    ...
    function navTo(section) { closeDD(); document.body.style.overflow=''; swTab(section); const el = $('tab_' + section); if (el) el.scrollIntoView({ behavior: 'auto', block: 'start' }); if (section === 'crypto' && $('navCryptoBadge')) $('navCryptoBadge').textContent = allC.length ? allC.length.toLocaleString() : '--' }
